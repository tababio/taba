...
# includes'libpython3.6m.so.1.0','libc.so.6' -> dár erro de fragmentação tem que apagar depois
buildOptions = dict(
    ...
    bin_includes = ['libpython3.6m.so.1.0','libc.so.6'], # deve apagar antes de distribuir para nao dar erro de fragmentacao
    include_files = ['img',],
